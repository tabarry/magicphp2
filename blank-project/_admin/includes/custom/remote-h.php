...
if ($table == USERS_TABLE_NAME && $_POST['_____profile'] == 'profile') {
    $_POST['status'] = 'Active';
    $_POST['user_group'] = $_SESSION[SESSION_PREFIX . 'user_group'];
}
//User cannot update anyone else's profile
if (($table == USERS_TABLE_NAME && $_POST['_____profile'] == 'profile') && (suDecrypt($_POST['id']) != $_SESSION[SESSION_PREFIX . 'user_id'])) {
