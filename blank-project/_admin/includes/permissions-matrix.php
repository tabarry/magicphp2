                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($valueGr['show_sorting_module'] == 'Yes') { ?>
                                <div class="pretty p-default p-curve p-thick size-80">
                                    <?php
                                    if (in_array(suUnstrip($valueGr['slug']), $resultPreviousGroups['sort_access'])) {
                                        $checkedSA = "checked='checked'";
                                    } else {
                                        $checkedSA = "";
                                    }
                                    ?>
                                    <input title='Sort' <?php echo $checkedSA; ?> type="checkbox" name="sort_access[]" id="sort_access[]" value="<?php echo suUnstrip($valueGr['slug']); ?>"  />
                                    <div class="state p-warning">
                                        <label>Sort</label>
                                    </div>
                                </div>
